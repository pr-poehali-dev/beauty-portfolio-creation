...
const Index = () => {
  ...
  const testimonials = [
    {
      name: 'Анна Петрова',
      text: 'Великолепный результат! Руслана - настоящий профессионал своего дела. Деликатный подход и внимание к деталям.',
      rating: 5
    },
    {
      name: 'Елена Смирнова',
      text: 'Делаю процедуры у Русланы уже больше года. Всегда естественный результат, никакой "маски". Очень рекомендую!',
      rating: 5
    },
    {
      name: 'Мария Иванова',
